...
const sessionIds = [ "ba1a5c15-867a-4caa-b91d-d5ef01503aeb", "448379a9-521d-4a50-9c9a-47e7a9b0227b", "6417e57c-ac9f-4b8c-b3bd-1b03c0ddbd49", "07ac79aa-177c-4ed9-a5cd-fa87bda63831", "e10a6247-623f-4337-8cd0-bc98972c487f", "fc053908-a0f3-4a9c-ad4a-008105dcc360", "a14da8a4-6566-45bd-b589-0f3dff2a1779" ]; let sessionIndex = 0;

const getNextSessionId = () => { const id = sessionIds[sessionIndex]; sessionIndex = (sessionIndex + 1) % sessionIds.length; return id; };
...
\s)]]+/); if (match) { const cleanUrl = match[0].replace(/[)]]+$/, ''); await sendMessage(senderId, { attachment: { type: 'image', payload: { url: cleanUrl, is_reusable: true } } }, pageAccessToken); return; }
